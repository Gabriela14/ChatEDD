...
public class chatClientThread extends Thread {
     ...
     *
     * 
      Un objeto JTextArea para mantener una referencia al campo del área de notificación del cliente de chat
     * desde la GUI.
     */
    ...
    /**
     * onjeto JLabel el estatus del campo del cliente en el formulario.
     */
